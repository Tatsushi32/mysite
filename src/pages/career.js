              ...
              <div className="timeline">
                ...
                <div className="timeline-content">
                  ...
                  <p className="description nexseed">
                    TOEFLで及第点を取得しアメリカ行きの切符を手にしたが、英語だけの留学は面白くないと感じ辞退。1年間大学を休学し、フィリピンで英語とプログラミングの学習ができるNexSeedに留学。チーム開発を通してプログラミングの基礎を学習(html, css, javascript, php)。プログラミングにはまってしまい英語を勉強しなくなる。
                  </p>
                </div>
              </div>
              <div className="timeline">
